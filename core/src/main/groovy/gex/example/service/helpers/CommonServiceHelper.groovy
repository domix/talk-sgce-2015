...
import gex.example.CoreConfigObject
...
class CommonServiceHelper {
  ...
  def toDtoPage(Map mapPage, Closure dtoTransformation = null){
    ...
    Class dtoClazz = equivalence?.dto ?: Class.forName("gex.example.dto.v1.${domainClazz.simpleName}")
    ...
    Class pageClazz = equivalence?.page ?: Class.forName("gex.example.dto.v1.${domainClazz.simpleName}Page")
