(function (root, client) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ApiClient = client(root.popsicle);
  }
  ...
  function Resource0 (uri, client) {
    ...
    this.hello = new Resource1(uri + '/hello', client);
    this.xkcd = new Resource2(uri + '/xkcd', client);
    this.heroes = new Resource3(uri + '/heroes', client);
  };
  ...
  Resource3.prototype.name = function (/* ...args */) {
